...
title: 主页面
---
这是一个基于quartz+github搭建的数字花园！！！

-  [主页面 (con.tc)地址1](https://zhzhzh.con.tc/)
- [主页面 (zhzhzh.cloudns.ch)地址2](https://a.zhzhzh.cloudns.ch/)，一切正常，有时会感觉有点慢。
- [主页面 (zhzhzh.cloudns.ch)地址3](http://d.zhzhzh.cloudns.ch/)，有加速，更新有延迟，没弄ssl，一些时候会被拦。
